...
- Nom, email, téléphone
- Informations relatives au véhicule et au vitrage
- Adresse et ville

Ces données sont utilisées uniquement pour traiter votre demande de devis et vous recontacter. Elles ne sont ni vendues ni transmises à des tiers à des fins commerciales.

**Durée de conservation :** les données sont conservées pour une durée maximale de 3 ans à compter du dernier contact.

Pour exercer vos droits, contactez-nous à [contact@edenglass.fr](mailto:contact@edenglass.fr).

## Cookies

Le site edenglass.fr n'utilise pas de cookies publicitaires ou de traçage. Seuls des cookies techniques strictement nécessaires au fonctionnement du site peuvent être utilisés.
